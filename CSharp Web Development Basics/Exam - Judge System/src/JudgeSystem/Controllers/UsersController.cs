namespace JudgeSystem.Controllers
{
    ...
    using JudgeSystem.ViewModels.Users;
    ...
    public class UsersController : BaseController
    {
        ...
        {
            // Validate
            if (model.TermsAndConditions != "Agree")
            {
                return this.BadRequestErrorWithView("Please agree with the official Terms and Conditions.");
            }
